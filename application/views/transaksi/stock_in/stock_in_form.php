<section class="content-header">
    <h1>Stock</h1><small>Barang Masuk / Pemeblian</small>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right"><a href="<?= site_url('stock/in') ?>" class="btn btn-info btn-flat">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('stock/proses') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="" id="detail" placeholder="Kulakan/Tambahan/dll" name="detail" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="suplier" class="form-control">
                                ...
                                <?php
                                foreach ($suplier as $s => $data) {
                                    echo '<option value="'.$data->suplier_id.'">'.$data->nama.'</option>';
                                }
                                ?>
                            </select>
                        </div>
