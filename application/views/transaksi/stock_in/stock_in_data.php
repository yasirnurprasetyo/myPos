<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h1 class="box-title">Data Stock In Barang</h1>
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                <a class="btn btn-warning btn-xs" id="set_detail" 
                                    ...
                                    data-supliernama="<?= $data->suplier_nama ?>" 
                                    data-qty="<?= $data->qty ?>" 
                                    data-date="<?= $data->date ?>">
            ...
            <div class="modal-body table-responsive">
                <table class="table table-bordered no-margin">
                    <tbody>
                        ...
                        <tr>
                            <th>Suplier</th>
                            <td><span id="suplier_nama"></span></td>
                        </tr>
                        <tr>
                            <th>Jumlah</th>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '#set_detail', function() {
            ...
            var supliernama = $(this).data('supliernama');
            var qty = $(this).data('qty');
            var date = $(this).data('date');
            $('#barcode').text(barcode);
            $('#item_nama').text(itemnama);
            $('#detail').text(detail);
            $('#suplier_nama').text(supliernama);
            $('#qty').text(qty);
            $('#date').text(date);
        })
    })
